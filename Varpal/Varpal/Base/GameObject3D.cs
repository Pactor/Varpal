...
namespace Varpal.Base
{
    ...
    {
        /// <summary>
        /// The 3D Model assigned to this object.
        /// </summary>
        ...
        /// <summary>
        /// Gets or Sets if this object is active or not
        /// </summary>
        public bool IsActive { get; set; }

        /// <summary>
        /// A Sphere drawn around our object, used for collision.
        /// </summary>
        public BoundingSphere BoundingSphere { get; set; }

        /// <summary>
        /// A base 3d game object
        /// </summary>
        public GameObject3D(GameScreen screen)
            :base(screen)
        {
        }
