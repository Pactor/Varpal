...
{
    public class CollectableItem : GameObject3D
    {
        public bool Retrieved { get; set; }

        /// <summary>
        /// This is a 3d object in game, that we can pick up
        /// </summary>
        public CollectableItem(GameScreen screen)
            :base(screen)
        {
            Retrieved = false;
        }
        ...
        /// <summary>
        /// Loads the Model for this 3d object
        /// </summary>
        /// <param name="content">Our content manager in charge of drawing</param>
        /// <param name="modelName">The model we want</param>
